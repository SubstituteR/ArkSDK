...
#include "ARK_Phoenix_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Event, Static, Protected, Delegate, NetServer, HasDefaults, DLLImport, Const)
// Parameters:
// int                            AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Event, NetResponse, Static, Protected, Delegate, NetServer, HasDefaults, DLLImport, Const)
// Parameters:
...
// (Exec, Event, NetMulticast, Protected, Delegate, NetServer, HasDefaults, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, NetResponse, NetMulticast, Protected, Delegate, NetServer, HasDefaults, DLLImport, Const)
// Parameters:
