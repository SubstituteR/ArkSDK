...
#include "ARK_BossArenaManager_parameters.hpp"
...
// (NetReliable, NetResponse, Static, MulticastDelegate, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
...
// (Net, NetRequest, Exec, Native, MulticastDelegate, Public, Private, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, Event, Static, NetMulticast, MulticastDelegate, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
...
// (Net, NetRequest, Exec, Static, MulticastDelegate, Public, Private, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
