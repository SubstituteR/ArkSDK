...
#include "ARK_Structure_TrainingDummy_parameters.hpp"
...
// (Net, Exec, Native, Static, Protected, Delegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, Const, NetValidate)
