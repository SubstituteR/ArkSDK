...
#include "ARK_BaseSwarmChar_BP_parameters.hpp"
...
// (NetReliable, Exec, Native, Event, NetMulticast, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Exec, NetResponse, NetMulticast, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, Event, NetResponse, NetMulticast, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Event, NetResponse, Static, NetMulticast, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (NetRequest, Event, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, NetResponse, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                  Victim                         (Parm, ZeroConstructor, IsPlainOldData)

void ABaseSwarmChar_BP_C::Damage_Victim_in_Radius(class AActor* Victim)
{
...
// (NetRequest, Exec, Event, Static, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
