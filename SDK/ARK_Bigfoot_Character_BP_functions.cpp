...
#include "ARK_Bigfoot_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Native, Static, MulticastDelegate, Protected, Delegate, NetServer, HasDefaults, NetClient, Const)
// Parameters:
...
// (NetRequest, Exec, NetMulticast, MulticastDelegate, Protected, Delegate, NetServer, HasDefaults, NetClient, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Native, Public, Delegate, NetServer, DLLImport, Const)
...
// (Exec, NetResponse, Public, Delegate, NetServer, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
