...
#include "ARK_Para_Character_BP_parameters.hpp"
...
// (Net, NetRequest, Exec, NetResponse, Static, MulticastDelegate, Protected, Delegate, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Native, Event, NetResponse, Static, Public, Private, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
