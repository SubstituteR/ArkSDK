...
#include "ARK_TekJumpPad_parameters.hpp"
...
// (NetReliable, NetRequest, Event, Static, MulticastDelegate, Public, HasOutParms, HasDefaults, DLLImport, Const)
...
// (Net, NetRequest, NetResponse, Static, MulticastDelegate, Public, Protected, Delegate, NetServer, HasDefaults, DLLImport, Const)
// Parameters:
...
// (Exec, Native, Event, NetResponse, Static, MulticastDelegate, Public, Protected, Delegate, NetServer, HasDefaults, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetRequest, Native, Event, Static, NetMulticast, MulticastDelegate, Public, HasOutParms, HasDefaults, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, HasOutParms, HasDefaults, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
