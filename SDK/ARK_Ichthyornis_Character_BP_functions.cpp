...
#include "ARK_Ichthyornis_Character_BP_parameters.hpp"
...
// (Net, NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast, Public, Private, Protected, Delegate, NetServer, DLLImport, Const)
// Parameters:
...
// (NetReliable, Native, MulticastDelegate, Private, Protected, Delegate, HasOutParms, DLLImport, Const)
// Parameters:
...
// (Exec, Event, NetMulticast, MulticastDelegate, Private, Protected, Delegate, HasOutParms, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, NetResponse, Public, HasOutParms, DLLImport, Const)
// Parameters:
...
// (NetRequest, Exec, Native, Event, Static, Public, HasOutParms, DLLImport, Const)
// Parameters:
// class APrimalCharacter*        Target                         (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Event, NetMulticast, Public, HasOutParms, DLLImport, Const)
// Parameters:
...
// (NetRequest, Exec, NetResponse, Static, NetMulticast, Public, HasOutParms, DLLImport, Const)
// Parameters:
...
// (NetReliable, Native, Public, HasOutParms, DLLImport, Const)
// Parameters:
...
// (Exec, NetResponse, Static, Public, HasOutParms, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Exec, Native, NetMulticast, Public, HasOutParms, DLLImport, Const)
// Parameters:
...
// (NetRequest, Native, Event, NetResponse, Static, NetMulticast, Public, HasOutParms, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
