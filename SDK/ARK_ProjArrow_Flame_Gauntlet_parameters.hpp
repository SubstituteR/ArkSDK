...
#include "ARK_ProjArrow_Flame_Gauntlet_classes.hpp"
...
struct AProjArrow_Flame_Gauntlet_C_OnExplode_Params
{
	struct FHitResult                                  Result;                                                   // (Parm, OutParm, ReferenceParm)
};

// Function ProjArrow_Flame_Gauntlet.ProjArrow_Flame_Gauntlet_C.UserConstructionScript
struct AProjArrow_Flame_Gauntlet_C_UserConstructionScript_Params
{
};

// Function ProjArrow_Flame_Gauntlet.ProjArrow_Flame_Gauntlet_C.ExecuteUbergraph_ProjArrow_Flame_Gauntlet
struct AProjArrow_Flame_Gauntlet_C_ExecuteUbergraph_ProjArrow_Flame_Gauntlet_Params
{
