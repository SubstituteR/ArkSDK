...
#include "ARK_WeapScoutRemote_parameters.hpp"
...
// (Net, NetReliable, NetRequest, NetMulticast, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, NetMulticast, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
...
// (NetReliable, Exec, Native, NetMulticast, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
...
// (NetRequest, Exec, Native, NetResponse, Static, Private, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
...
// (NetRequest, Native, Event, NetMulticast, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
