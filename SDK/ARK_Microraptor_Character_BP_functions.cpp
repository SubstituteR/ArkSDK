...
#include "ARK_Microraptor_Character_BP_parameters.hpp"
...
// (NetReliable, NetResponse, NetMulticast, MulticastDelegate, Public, Private, Delegate, DLLImport, Const)
...
// (NetReliable, Native, Event, Static, NetMulticast, MulticastDelegate, Public, Private, Delegate, DLLImport, Const)
// Parameters:
// int                            AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, Delegate, DLLImport, Const)
// Parameters:
...
// (NetReliable, Native, Static, MulticastDelegate, Private, Delegate, HasOutParms, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
