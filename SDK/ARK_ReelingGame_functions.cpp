...
#include "ARK_ReelingGame_parameters.hpp"
...
// (NetRequest, Exec, NetResponse, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (Exec, Native, Event, NetResponse, Static, NetMulticast, Private, Protected, Delegate, NetServer, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
// struct FGeometry*              MyGeometry                     (Parm, IsPlainOldData)
...
// (NetRequest, Private, Protected, Delegate, NetServer, HasDefaults, DLLImport, BlueprintCallable, Const)
...
// (NetReliable, NetRequest, Native, Private, Protected, Delegate, NetServer, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
// struct FGeometry*              MyGeometry                     (Parm, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, Native, Private, Protected, Delegate, NetServer, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (Net, NetRequest, Exec, Native, Event, Static, Public, Private, Protected, Delegate, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
// struct FGeometry*              MyGeometry                     (Parm, IsPlainOldData)
