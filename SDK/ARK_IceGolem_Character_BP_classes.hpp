...
#include "ARK_IceGolem_Character_BP_structs.hpp"
...
// BlueprintGeneratedClass IceGolem_Character_BP.IceGolem_Character_BP_C
// 0x01ED (0x22F5 - 0x2108)
class AIceGolem_Character_BP_C : public ADino_Character_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass IceGolem_Character_BP.IceGolem_Character_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_IceGolem_Character_BP(int EntryPoint);
};
