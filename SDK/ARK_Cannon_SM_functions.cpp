...
#include "ARK_Cannon_SM_parameters.hpp"
...
// (NetReliable, Native, NetResponse, NetMulticast, Public, Private, Protected, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetRequest, Static, NetMulticast, Public, Private, Protected, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
