...
#include "ARK_BP_DedicatedStorage_parameters.hpp"
...
// (NetRequest, Exec, Event, NetResponse, Public, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
