...
#include "ARK_DesertKaiju_Character_BP_parameters.hpp"
...
// (NetRequest, Exec, Native, Event, Static, NetMulticast, MulticastDelegate, Public, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetRequest, Native, Event, MulticastDelegate, Public, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Native, NetResponse, Static, MulticastDelegate, Public, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
...
// (NetReliable, Exec, Native, Event, Static, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, NetResponse, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (Static, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, Static, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (Net, Exec, Event, NetResponse, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, Event, NetResponse, Static, Public, Private, NetServer, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// struct FVector                 ExplosionLoc                   (Parm, ZeroConstructor, IsPlainOldData)
// bool                           OnKaiju                        (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, Event, NetMulticast, Public, Private, NetServer, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// bool                           FirstFlock                     (Parm, ZeroConstructor, IsPlainOldData)
