...
#include "ARK_Hesperornis_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Event, MulticastDelegate, Public, Protected, NetServer, DLLImport, Const)
...
// (NetRequest, Event, NetResponse, MulticastDelegate, Public, Protected, NetServer, DLLImport, Const)
// Parameters:
...
// (NetRequest, Native, Static, MulticastDelegate, Public, Protected, NetServer, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, MulticastDelegate, Public, Protected, NetServer, DLLImport, Const)
// Parameters:
// class APrimalCharacter*        Player                         (Parm, ZeroConstructor, IsPlainOldData)
// bool                           IsValid                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void AHesperornis_Character_BP_C::STATIC_FishHasVit(class APrimalCharacter* Player, bool* IsValid)
{
...
// (NetReliable, NetRequest, Event, NetResponse, MulticastDelegate, Public, Private, Protected, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
