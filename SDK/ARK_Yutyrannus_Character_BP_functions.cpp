...
#include "ARK_Yutyrannus_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Native, MulticastDelegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, NetResponse, Static, MulticastDelegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// float                          coneRadius                     (Parm, ZeroConstructor, IsPlainOldData)
// class APrimalCharacter*        OtherCharacter                 (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, Event, NetMulticast, MulticastDelegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Exec, Static, NetMulticast, MulticastDelegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Native, NetResponse, Static, MulticastDelegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
