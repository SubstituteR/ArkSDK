...
#include "ARK_Dragon_AIController_Bp_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, Event, NetMulticast, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
