...
#include "ARK_Buff_SpaceWhaleTeleport_parameters.hpp"
...
// (NetRequest, Exec, NetResponse, Public, Private, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor**                 ForInstigator                  (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Native, Event, Static, MulticastDelegate, Private, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, NetResponse, Static, MulticastDelegate, Private, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
