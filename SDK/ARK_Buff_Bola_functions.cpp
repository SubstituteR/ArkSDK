...
#include "ARK_Buff_Bola_parameters.hpp"
...
// (NetReliable, Exec, NetResponse, Static, MulticastDelegate, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (Native, Event, NetResponse, Static, MulticastDelegate, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
