...
#include "ARK_Service_FKaijuMaybeSpawnTreesAndWyverns_parameters.hpp"
...
// (NetRequest, Event, Static, NetMulticast, MulticastDelegate, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Protected, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           Success                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)
