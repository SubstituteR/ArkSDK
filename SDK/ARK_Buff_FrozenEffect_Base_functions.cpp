...
#include "ARK_Buff_FrozenEffect_Base_parameters.hpp"
...
// (NetRequest, Exec, Native, Static, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
