...
#include "ARK_Buff_ParaWarningAlert_parameters.hpp"
...
// (Net, NetRequest, Exec, NetResponse, Static, Public, Private, Delegate, NetServer, HasOutParms, BlueprintCallable, BlueprintPure)
// Parameters:
