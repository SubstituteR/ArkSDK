...
#include "ARK_Underwater_Base_SM_parameters.hpp"
...
// (NetReliable, NetRequest, NetResponse, Static, Public, Private, Protected, NetServer, DLLImport, BlueprintCallable, Const)
