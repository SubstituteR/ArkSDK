...
#include "ARK_MissionType_GlitchCounter_Base_parameters.hpp"
...
// (NetReliable, Native, Event, NetResponse, Static, NetMulticast, Public, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintEvent, NetValidate)
// Parameters:
// class APlayerController**      ShootCont                      (Parm, ZeroConstructor, IsPlainOldData)
// class FString                  ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)

class FString AMissionType_GlitchCounter_Base_C::STATIC_GetMissionDisplayName(class APlayerController** ShootCont)
{
