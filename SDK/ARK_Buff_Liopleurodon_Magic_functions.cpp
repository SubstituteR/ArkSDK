...
#include "ARK_Buff_Liopleurodon_Magic_parameters.hpp"
...
// (NetReliable, Native, Event, NetMulticast, MulticastDelegate, Public, Protected, HasDefaults, NetClient, Const)
// Parameters:
...
// (Exec, Native, NetMulticast, Public, Private, Delegate, NetServer, HasOutParms, BlueprintCallable, BlueprintPure)
// Parameters:
