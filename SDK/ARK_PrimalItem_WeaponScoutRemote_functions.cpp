...
#include "ARK_PrimalItem_WeaponScoutRemote_parameters.hpp"
...
// (Native, Event, NetMulticast, MulticastDelegate, Private, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
...
// (NetRequest, Exec, NetResponse, NetMulticast, MulticastDelegate, Private, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
...
// (Net, NetReliable, NetRequest, Exec, NetResponse, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
...
// (Net, NetReliable, Static, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
