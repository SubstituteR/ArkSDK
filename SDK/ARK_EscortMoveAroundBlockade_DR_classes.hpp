...
#include "ARK_EscortMoveAroundBlockade_DR_structs.hpp"
...
class UEscortMoveAroundBlockade_DR_C : public UBTDecorator_BlueprintBase
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass EscortMoveAroundBlockade_DR.EscortMoveAroundBlockade_DR_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_EscortMoveAroundBlockade_DR(int EntryPoint);
};
