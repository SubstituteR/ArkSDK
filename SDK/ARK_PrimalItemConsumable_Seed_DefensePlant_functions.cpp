...
#include "ARK_PrimalItemConsumable_Seed_DefensePlant_parameters.hpp"
...
// (Net, NetReliable, NetResponse, MulticastDelegate, Private, Delegate, NetServer, NetClient, DLLImport, Const)
// Parameters:
