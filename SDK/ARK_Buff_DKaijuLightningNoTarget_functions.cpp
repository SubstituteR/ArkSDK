...
#include "ARK_Buff_DKaijuLightningNoTarget_parameters.hpp"
...
// (NetRequest, Exec, Native, Event, NetResponse, Static, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
// class AActor**                 ForInstigator                  (Parm, ZeroConstructor, IsPlainOldData)

void ABuff_DKaijuLightningNoTarget_C::STATIC_BPDeactivated(class AActor** ForInstigator)
{
