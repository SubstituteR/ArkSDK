...
#include "ARK_FishBasket_parameters.hpp"
...
// (Exec, NetResponse, Static, NetMulticast, Private, NetServer, HasOutParms, HasDefaults, DLLImport, Const)
// Parameters:
...
// (NetReliable, Exec, Native, NetResponse, MulticastDelegate, Private, Protected, HasDefaults, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
