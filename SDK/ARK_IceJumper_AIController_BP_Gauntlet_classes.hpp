...
#include "ARK_IceJumper_AIController_BP_Gauntlet_structs.hpp"
...
// 0x0004 (0x0A14 - 0x0A10)
class AIceJumper_AIController_BP_Gauntlet_C : public AIceJumper_AIController_BP_C
{
public:
	float                                              AIShouldMeleeDuration;                                    // 0x0A10(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
