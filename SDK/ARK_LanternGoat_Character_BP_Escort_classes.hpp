...
#include "ARK_LanternGoat_Character_BP_Escort_structs.hpp"
...
// BlueprintGeneratedClass LanternGoat_Character_BP_Escort.LanternGoat_Character_BP_Escort_C
// 0x0162 (0x25A2 - 0x2440)
class ALanternGoat_Character_BP_Escort_C : public ALanternGoat_Character_BP_C
{
public:
	...
	class UAudioComponent*                             Audio1;                                                   // 0x2448(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    ParticleSystem2;                                          // 0x2450(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    ParticleSystem1;                                          // 0x2458(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMesh1;                                              // 0x2460(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMesh2;                                              // 0x2468(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass LanternGoat_Character_BP_Escort.LanternGoat_Character_BP_Escort_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_LanternGoat_Character_BP_Escort(int EntryPoint);
};
