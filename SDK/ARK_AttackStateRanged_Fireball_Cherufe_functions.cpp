...
#include "ARK_AttackStateRanged_Fireball_Cherufe_parameters.hpp"
...
// (NetReliable, Native, NetResponse, Static, MulticastDelegate, Public, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
