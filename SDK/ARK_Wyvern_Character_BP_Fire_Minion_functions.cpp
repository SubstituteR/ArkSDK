...
#include "ARK_Wyvern_Character_BP_Fire_Minion_parameters.hpp"
...
// (NetReliable, Exec, Native, Event, NetResponse, NetMulticast, Public, Protected, NetServer, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
...
// (NetRequest, Native, Static, MulticastDelegate, Private, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
