...
#include "ARK_Base_Pipe_Flex_parameters.hpp"
...
// (Event, NetResponse, Static, NetMulticast, Public, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Native, Event, Public, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
