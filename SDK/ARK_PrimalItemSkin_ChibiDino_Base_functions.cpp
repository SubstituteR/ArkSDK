...
#include "ARK_PrimalItemSkin_ChibiDino_Base_parameters.hpp"
...
// (NetRequest, Native, Event, NetResponse, Public, Delegate, NetServer, HasDefaults, NetClient, Const)
// Parameters:
// class FString                  ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm)
...
// (NetRequest, Exec, Native, NetMulticast, Delegate, HasDefaults, NetClient, Const)
// Parameters:
...
// (NetReliable, Exec, NetResponse, NetMulticast, Delegate, HasDefaults, NetClient, Const)
// Parameters:
...
// (NetReliable, Exec, Native, NetResponse, NetMulticast, Delegate, HasDefaults, NetClient, Const)
...
// (Exec, NetResponse, Static, Public, Delegate, NetServer, HasDefaults, NetClient, Const)
// Parameters:
...
class FString UPrimalItemSkin_ChibiDino_Base_C::STATIC_BPGetItemDescription(class FString* InDescription, bool* bGetLongDescription, class AShooterPlayerController** ForPC)
{
