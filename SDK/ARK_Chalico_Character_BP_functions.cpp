...
#include "ARK_Chalico_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Native, Event, NetMulticast, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
...
// (Exec, Static, NetMulticast, HasOutParms, NetClient, DLLImport, Const)
