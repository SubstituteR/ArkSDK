...
#include "ARK_SpaceWhale_AIController_BP_parameters.hpp"
...
// (NetReliable, Event, NetResponse, Static, MulticastDelegate, Private, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
