...
#include "ARK_Megatherium_Character_BP_parameters.hpp"
...
// (NetRequest, Exec, Static, NetMulticast, MulticastDelegate, Private, Delegate, HasOutParms, DLLImport, Const)
// Parameters:
...
// (NetReliable, MulticastDelegate, Private, Delegate, HasOutParms, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// (NetReliable, NetRequest, Native, Event, MulticastDelegate, Private, Delegate, HasOutParms, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
