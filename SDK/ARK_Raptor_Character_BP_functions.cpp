...
#include "ARK_Raptor_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// (Net, NetReliable, NetRequest, Exec, NetMulticast, MulticastDelegate, Protected, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
