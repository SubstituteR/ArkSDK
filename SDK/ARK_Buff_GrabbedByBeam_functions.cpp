...
#include "ARK_Buff_GrabbedByBeam_parameters.hpp"
...
// (Exec, Native, NetResponse, Static, Delegate, HasOutParms, HasDefaults, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
