...
#include "ARK_PrimalItemResource_Element_parameters.hpp"
...
// (Exec, Event, NetResponse, Public, Private, Protected, Delegate, HasOutParms, BlueprintCallable, Const)
// Parameters:
...
// (Native, Event, NetResponse, Static, Public, Private, Protected, Delegate, HasOutParms, BlueprintCallable, Const)
...
// (Net, Native, NetResponse, NetMulticast, MulticastDelegate, Private, Protected, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
