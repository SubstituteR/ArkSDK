...
#include "ARK_PrimalItemResource_Gasoline_parameters.hpp"
...
// (NetReliable, Exec, Event, Public, Private, Protected, Delegate, HasOutParms, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, Exec, Native, Event, Public, Private, Protected, Delegate, HasOutParms, BlueprintCallable, Const)
// Parameters:
// class UPrimalItem*             DestinationItem                (Parm, ZeroConstructor, IsPlainOldData)
