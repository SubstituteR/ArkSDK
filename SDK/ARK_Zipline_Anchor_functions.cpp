...
#include "ARK_Zipline_Anchor_parameters.hpp"
...
// (NetRequest, Exec, NetResponse, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, Static, NetMulticast, MulticastDelegate, Public, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
...
// (NetReliable, NetRequest, NetResponse, MulticastDelegate, Public, Private, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (NetRequest, Native, Event, NetResponse, Static, MulticastDelegate, Public, Private, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
// class APlayerController*       PC                             (Parm, ZeroConstructor, IsPlainOldData)
// class UClass*                  ZiplineBuff                    (Parm, ZeroConstructor, IsPlainOldData)

void AZipline_Anchor_C::STATIC_RideZipline(class APlayerController* PC, class UClass* ZiplineBuff)
{
...
// (NetReliable, Exec, Native, NetMulticast, MulticastDelegate, Public, Private, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
