...
#include "ARK_Liopleurodon_Character_BP_Retrieve_structs.hpp"
...
// BlueprintGeneratedClass Liopleurodon_Character_BP_Retrieve.Liopleurodon_Character_BP_Retrieve_C
// 0x0028 (0x2280 - 0x2258)
class ALiopleurodon_Character_BP_Retrieve_C : public ALiopleurodon_Character_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Liopleurodon_Character_BP_Retrieve.Liopleurodon_Character_BP_Retrieve_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Liopleurodon_Character_BP_Retrieve(int EntryPoint);
};
