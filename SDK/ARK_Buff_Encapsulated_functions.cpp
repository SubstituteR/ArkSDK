...
#include "ARK_Buff_Encapsulated_parameters.hpp"
...
// (Net, NetReliable, NetRequest, Native, Event, Static, NetMulticast, Private, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
// float                          Damage                         (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Exec, Event, NetResponse, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
// class AActor**                 ForInstigator                  (Parm, ZeroConstructor, IsPlainOldData)
