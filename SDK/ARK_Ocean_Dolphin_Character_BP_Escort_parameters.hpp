...
#include "ARK_Ocean_Dolphin_Character_BP_Escort_classes.hpp"
...
struct AOcean_Dolphin_Character_BP_Escort_C_BP_ForceAllowAddBuff_Params
{
...
struct AOcean_Dolphin_Character_BP_Escort_C_AllowGrappling_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Ocean_Dolphin_Character_BP_Escort.Ocean_Dolphin_Character_BP_Escort_C.BPDisplayTamedMessage
struct AOcean_Dolphin_Character_BP_Escort_C_BPDisplayTamedMessage_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Ocean_Dolphin_Character_BP_Escort.Ocean_Dolphin_Character_BP_Escort_C.UserConstructionScript
struct AOcean_Dolphin_Character_BP_Escort_C_UserConstructionScript_Params
{
};
...
struct AOcean_Dolphin_Character_BP_Escort_C_ExecuteUbergraph_Ocean_Dolphin_Character_BP_Escort_Params
{
