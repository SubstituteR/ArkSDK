...
#include "ARK_StructureTurretTek_parameters.hpp"
...
// (Net, NetRequest, NetResponse, Static, MulticastDelegate, Public, Private, Protected, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetRequest, Event, NetResponse, Static, NetMulticast, Public, Private, Protected, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, NetRequest, NetResponse, Private, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
