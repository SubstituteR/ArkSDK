...
#include "ARK_WeapFishingNet_parameters.hpp"
...
// (NetReliable, NetRequest, Native, Event, Static, NetMulticast, Public, Protected, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (Net, NetRequest, Exec, Native, NetResponse, Static, Private, Protected, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (Exec, NetMulticast, Public, Protected, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Static, Public, Protected, Delegate, NetServer, NetClient, DLLImport, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, NetMulticast, Public, Protected, Delegate, NetServer, NetClient, DLLImport, BlueprintEvent)
// Parameters:
