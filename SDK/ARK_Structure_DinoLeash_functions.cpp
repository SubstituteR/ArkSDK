...
#include "ARK_Structure_DinoLeash_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
...
// (Net, NetReliable, Native, Event, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
...
// (Net, Native, Event, Static, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
...
// (NetRequest, NetResponse, Static, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
