...
#include "ARK_Buff_MekBackpack_Shield_parameters.hpp"
...
// (NetRequest, Native, Event, NetMulticast, Private, Protected, NetServer, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
