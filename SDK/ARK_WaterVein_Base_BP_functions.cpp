...
#include "ARK_WaterVein_Base_BP_parameters.hpp"
...
// (NetReliable, NetResponse, Static, MulticastDelegate, Public, Protected, Delegate, HasDefaults, DLLImport, BlueprintCallable, Const)
// Parameters:
