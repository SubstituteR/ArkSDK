...
#include "ARK_Tusoteuthis_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Native, NetResponse, Static, MulticastDelegate, Private, Delegate, HasDefaults, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, Event, Static, NetMulticast, MulticastDelegate, Private, Delegate, HasDefaults, DLLImport, Const)
...
// (NetReliable, Native, NetResponse, Public, Delegate, HasDefaults, DLLImport, Const)
...
// (NetReliable, Exec, Native, NetResponse, Public, Delegate, HasDefaults, DLLImport, Const)
// Parameters:
