...
#include "ARK_Otter_Character_BP_parameters.hpp"
...
// (Native, Static, NetMulticast, Public, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, Const)
// Parameters:
...
// (NetRequest, Event, Private, Delegate, HasOutParms, HasDefaults, NetClient, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
