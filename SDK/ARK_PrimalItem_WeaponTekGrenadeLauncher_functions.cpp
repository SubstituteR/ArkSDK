...
#include "ARK_PrimalItem_WeaponTekGrenadeLauncher_parameters.hpp"
...
// (Net, NetRequest, Event, NetResponse, MulticastDelegate, Protected, HasOutParms, HasDefaults, DLLImport, Const)
// Parameters:
