...
#include "ARK_Emitter_HuntTracks_Mammoth_structs.hpp"
...
class AEmitter_HuntTracks_Mammoth_C : public AEmitter_HuntTracks_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Emitter_HuntTracks_Mammoth.Emitter_HuntTracks_Mammoth_C");
		return ptr;
	}


	void UserConstructionScript();
	void ExecuteUbergraph_Emitter_HuntTracks_Mammoth(int EntryPoint);
};
