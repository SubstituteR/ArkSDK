...
#include "ARK_Buff_TekSniper_XRay_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, Event, NetMulticast, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
