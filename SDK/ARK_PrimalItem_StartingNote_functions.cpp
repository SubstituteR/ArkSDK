...
#include "ARK_PrimalItem_StartingNote_parameters.hpp"
...
// (Native, Event, NetMulticast, Protected, Delegate, NetServer, NetClient, DLLImport, Const)
// Parameters:
// class AShooterPlayerController* ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetResponse, NetMulticast, Protected, Delegate, NetServer, NetClient, DLLImport, Const)
// Parameters:
...
// (Net, NetRequest, Exec, Native, Event, NetResponse, NetMulticast, MulticastDelegate, Private, Delegate, NetServer, NetClient, DLLImport, Const)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetResponse, NetMulticast, Protected, Delegate, NetServer, NetClient, DLLImport, Const)
// Parameters:
