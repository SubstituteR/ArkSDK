...
#include "ARK_Buff_InsideMekShield_parameters.hpp"
...
// (Exec, Event, NetResponse, NetMulticast, Public, Protected, Delegate, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
