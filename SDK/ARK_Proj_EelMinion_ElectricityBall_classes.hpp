...
#include "ARK_Proj_EelMinion_ElectricityBall_structs.hpp"
...
class AProj_EelMinion_ElectricityBall_C : public AShooterProjectile
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Proj_EelMinion_ElectricityBall.Proj_EelMinion_ElectricityBall_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_Proj_EelMinion_ElectricityBall(int EntryPoint);
};
