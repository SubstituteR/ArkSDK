...
#include "ARK_PlayerControllerBlueprint_parameters.hpp"
...
// (NetReliable, Event, Static, NetMulticast, MulticastDelegate, Delegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, Const, NetValidate)
// Parameters:
