...
#include "ARK_Bee_Queen_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, Static, NetMulticast, Public, Delegate, NetServer, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetResponse, Static, NetMulticast, Public, Delegate, NetServer, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Native, Event, NetResponse, Static, NetMulticast, Public, Delegate, NetServer, DLLImport, Const)
// Parameters:
