...
#include "ARK_Buff_WhipForTamedDino_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, NetResponse, Public, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, Const)
// Parameters:
