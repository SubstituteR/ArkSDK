...
#include "ARK_StorageBox_TekShield_parameters.hpp"
...
// (NetReliable, Exec, Event, NetMulticast, Private, Delegate, HasOutParms, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, NetRequest, NetResponse, NetMulticast, Private, Delegate, HasOutParms, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, NetRequest, Native, Event, Static, NetMulticast, Private, Delegate, HasOutParms, DLLImport, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
