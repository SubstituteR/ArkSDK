...
#include "ARK_BeeHive_parameters.hpp"
...
// (Net, Event, Static, MulticastDelegate, Private, Protected, HasDefaults, DLLImport, Const)
// Parameters:
...
// (Net, NetRequest, Native, Event, NetResponse, Static, MulticastDelegate, Private, Protected, HasDefaults, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
