...
#include "ARK_Buff_MekBackpack_Base_parameters.hpp"
...
// (NetRequest, Native, Event, NetResponse, Public, Protected, Delegate, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
