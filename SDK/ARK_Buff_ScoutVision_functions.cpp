...
#include "ARK_Buff_ScoutVision_parameters.hpp"
...
// (NetReliable, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
...
// (Net, NetReliable, NetRequest, Exec, MulticastDelegate, Public, Private, NetServer, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
