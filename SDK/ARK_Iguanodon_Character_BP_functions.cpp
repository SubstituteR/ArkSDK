...
#include "ARK_Iguanodon_Character_BP_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Native, Event, Static, MulticastDelegate, Public, Protected, Delegate, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
