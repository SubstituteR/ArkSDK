...
#include "ARK_GasBags_Character_BP_parameters.hpp"
...
// (Net, NetRequest, Event, NetResponse, MulticastDelegate, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, Exec, Native, Event, Static, MulticastDelegate, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Native, Event, Public, Private, Delegate, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, NetRequest, Exec, Native, Event, NetResponse, NetMulticast, MulticastDelegate, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Static, MulticastDelegate, Public, Private, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
...
// (NetRequest, Event, NetResponse, MulticastDelegate, Private, Protected, Delegate, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
