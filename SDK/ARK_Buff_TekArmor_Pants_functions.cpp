...
#include "ARK_Buff_TekArmor_Pants_parameters.hpp"
...
// (Native, Event, Static, MulticastDelegate, Public, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Public, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// float*                         DeltaTime                      (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Static, Public, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
...
// (NetReliable, NetRequest, Native, Event, NetResponse, Static, Public, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
