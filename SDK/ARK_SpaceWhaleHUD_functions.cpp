...
#include "ARK_SpaceWhaleHUD_parameters.hpp"
...
// (Exec, Event, Static, Private, Protected, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetMulticast, Public, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, Const)
// Parameters:
...
// (NetRequest, NetResponse, Static, Private, Protected, DLLImport, Const)
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)
...
// (Net, NetReliable, NetRequest, Exec, Event, NetResponse, Static, Private, Protected, DLLImport, Const)
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)
