...
#include "ARK_StorageBox_IndustrialGrinder_parameters.hpp"
...
// (Event, Static, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetRequest, Exec, Native, Event, NetResponse, Static, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Event, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Exec, NetResponse, NetMulticast, MulticastDelegate, Public, Private, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
