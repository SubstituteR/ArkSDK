...
#include "ARK_Buff_DinoTekHelmet_Base_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, NetMulticast, Public, Private, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool                           bAllowed                       (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABuff_DinoTekHelmet_Base_C::STATIC_IsAllowedToFire(bool* bAllowed)
{
...
// (Exec, Native, NetResponse, Public, Private, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
