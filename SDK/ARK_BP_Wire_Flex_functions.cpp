...
#include "ARK_BP_Wire_Flex_parameters.hpp"
...
// (NetReliable, NetRequest, Static, Public, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Event, Static, Public, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
