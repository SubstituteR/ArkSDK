...
#include "ARK_Buff_TekClaw_Target_MaxPower_parameters.hpp"
...
// (NetReliable, Event, Static, NetMulticast, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintCallable, BlueprintPure)
// Parameters:
