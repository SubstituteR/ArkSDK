...
#include "ARK_Base_TekDoor_parameters.hpp"
...
// (NetRequest, Exec, Event, NetResponse, NetMulticast, Public, Private, Protected, Delegate, HasOutParms, HasDefaults, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
