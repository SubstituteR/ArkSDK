...
#include "ARK_Wyvern_Character_BP_Base_parameters.hpp"
...
// (NetRequest, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Protected, Delegate, HasDefaults, DLLImport, BlueprintCallable, Const)
