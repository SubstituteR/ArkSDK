...
#include "ARK_DroppedItem_GachaPod_parameters.hpp"
...
// (NetReliable, Native, Event, Static, Public, Protected, NetServer, HasOutParms, HasDefaults, BlueprintCallable, BlueprintEvent)
