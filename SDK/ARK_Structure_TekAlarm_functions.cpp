...
#include "ARK_Structure_TekAlarm_parameters.hpp"
...
// (Event, NetResponse, NetMulticast, Private, Delegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, NetRequest, Exec, Event, Static, NetMulticast, Private, Delegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, Exec, Native, NetResponse, Private, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// TEnumAsByte<ETekAlarmTargetTypes> Type                           (Parm, ZeroConstructor, IsPlainOldData)
...
// (Net, NetReliable, Exec, Native, Event, NetResponse, Private, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Event, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           Result                         (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetResponse, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// TEnumAsByte<ETekAlarmTargetTypes> Type                           (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, NetResponse, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, NetResponse, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Exec, Event, NetResponse, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, Event, NetResponse, Static, Private, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, Event, Static, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            pinCode                        (Parm, ZeroConstructor, IsPlainOldData)
// bool                           ret                            (Parm, OutParm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
...
// (NetRequest, Native, Static, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Exec, Native, NetResponse, Static, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, NetResponse, NetMulticast, MulticastDelegate, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Exec, Native, Event, MulticastDelegate, Public, Protected, NetServer, HasOutParms, NetClient, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
