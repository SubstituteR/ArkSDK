...
#include "ARK_Buff_TekArmor_Shirt_Rework_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, NetServer, HasDefaults, NetClient, DLLImport, Const)
...
// (Event, Static, MulticastDelegate, Public, NetServer, BlueprintCallable, BlueprintEvent)
// Parameters:
// float*                         DeltaTime                      (Parm, ZeroConstructor, IsPlainOldData)
