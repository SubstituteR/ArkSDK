...
#include "ARK_Troodon_Character_BP_parameters.hpp"
...
// (NetReliable, Exec, Native, Event, Static, Public, Delegate, HasDefaults, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, Event, NetMulticast, Public, Delegate, HasDefaults, DLLImport, Const)
// Parameters:
...
// (NetReliable, NetResponse, NetMulticast, Public, Delegate, HasDefaults, DLLImport, Const)
