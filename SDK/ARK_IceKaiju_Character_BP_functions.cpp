...
#include "ARK_IceKaiju_Character_BP_parameters.hpp"
...
// (NetReliable, Exec, Event, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (Exec, Native, Static, NetMulticast, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintPure)
...
// (NetReliable, NetRequest, Event, NetResponse, Static, NetMulticast, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintPure)
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintPure)
...
// (NetRequest, Exec, NetMulticast, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
// TArray<struct UObject_FTransform> InSocketTransforms             (Parm, OutParm, ZeroConstructor, ReferenceParm)
...
// (NetRequest, Exec, NetResponse, Static, NetMulticast, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
...
// (Exec, Native, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
...
// (Exec, NetResponse, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
...
// (NetRequest, NetMulticast, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
...
// (NetReliable, Exec, Event, NetResponse, NetMulticast, MulticastDelegate, Private, Protected, Delegate, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
...
// (Net, Static, MulticastDelegate, Public, Private, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (Exec, NetResponse, NetMulticast, Protected, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, Protected, NetServer, HasOutParms, NetClient, DLLImport, Const)
...
// (NetReliable, Native, Event, NetResponse, Protected, NetServer, HasOutParms, NetClient, DLLImport, Const)
...
// (NetRequest, Event, NetResponse, Static, Protected, NetServer, HasOutParms, NetClient, DLLImport, Const)
// Parameters:
