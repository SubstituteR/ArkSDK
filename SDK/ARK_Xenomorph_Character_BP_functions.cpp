...
#include "ARK_Xenomorph_Character_BP_parameters.hpp"
...
// (Native, Event, NetMulticast, MulticastDelegate, Protected, Delegate, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, Exec, Native, Event, Static, NetMulticast, MulticastDelegate, Protected, Delegate, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, MulticastDelegate, Protected, Delegate, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, MulticastDelegate, Protected, Delegate, HasOutParms, BlueprintEvent, BlueprintPure)
// Parameters:
