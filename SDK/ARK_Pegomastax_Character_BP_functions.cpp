...
#include "ARK_Pegomastax_Character_BP_parameters.hpp"
...
// (Exec, Event, NetResponse, Static, NetMulticast, Public, Protected, Delegate, HasDefaults, NetClient, Const)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, Public, Private, HasOutParms, HasDefaults, NetClient, Const)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetMulticast, Public, Private, HasOutParms, HasDefaults, NetClient, Const)
// Parameters:
...
// (NetRequest, NetResponse, Static, NetMulticast, Public, Private, HasOutParms, HasDefaults, NetClient, Const)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Native, NetResponse, MulticastDelegate, Public, Private, Delegate, DLLImport, Const)
// Parameters:
...
// (NetReliable, Exec, NetResponse, Static, MulticastDelegate, Public, Private, Delegate, DLLImport, Const)
// Parameters:
...
// (NetReliable, Exec, NetResponse, NetMulticast, MulticastDelegate, Public, Private, Delegate, DLLImport, Const)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
