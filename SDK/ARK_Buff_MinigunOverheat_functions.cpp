...
#include "ARK_Buff_MinigunOverheat_parameters.hpp"
...
// (Net, Exec, Native, NetResponse, Static, NetMulticast, NetServer, HasOutParms, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
