...
#include "ARK_Buff_Leech_parameters.hpp"
...
// (NetReliable, NetRequest, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class APlayerController**      ForPC                          (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, Native, Private, Protected, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
