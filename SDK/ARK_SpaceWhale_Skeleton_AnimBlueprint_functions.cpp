...
#include "ARK_SpaceWhale_Skeleton_AnimBlueprint_parameters.hpp"
...
// (Static, NetMulticast, Public, Protected, Delegate, NetServer, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
