...
#include "ARK_WeapTekSniper_parameters.hpp"
...
// (NetReliable, NetRequest, Exec, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, Protected, NetServer, HasOutParms, BlueprintEvent, BlueprintPure)

void AWeapTekSniper_C::STATIC_BPAppliedPrimalItemToWeapon()
{
...
// (NetReliable, NetRequest, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)
