...
#include "ARK_BossTeleporter_parameters.hpp"
...
// (NetRequest, Native, Event, Static, NetMulticast, Private, Protected, Delegate, NetServer, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
