...
#include "ARK_WeaponRadioactiveLanternCharge_parameters.hpp"
...
// (Exec, Native, Event, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetRequest, Native, Static, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Exec, Native, NetResponse, Static, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)

void AWeaponRadioactiveLanternCharge_C::STATIC_ClientTick()
{
...
// (NetReliable, NetRequest, Event, NetResponse, Static, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)

void AWeaponRadioactiveLanternCharge_C::STATIC_Remove_All_BeamsClient()
{
...
// (NetRequest, Exec, Native, NetResponse, NetMulticast, Public, NetServer, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
