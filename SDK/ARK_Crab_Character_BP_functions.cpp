...
#include "ARK_Crab_Character_BP_parameters.hpp"
...
// (NetRequest, Exec, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Native, Event, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetRequest, Exec, Native, Event, Static, NetMulticast, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
...
// (NetReliable, Exec, Native, Delegate, NetServer, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetMulticast, Delegate, NetServer, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetResponse, Delegate, NetServer, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// int*                           AttackIndex                    (Parm, ZeroConstructor, IsPlainOldData)
