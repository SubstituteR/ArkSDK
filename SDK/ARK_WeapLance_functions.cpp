...
#include "ARK_WeapLance_parameters.hpp"
...
// (Exec, Native, Event, MulticastDelegate, Private, Protected, Delegate, NetServer, HasDefaults, NetClient, BlueprintCallable, Const)
// Parameters:
