...
#include "ARK_CoreUObject_structs.hpp"
...
public:
	...
	inline void ProcessEvent(class UFunction* func, void* params) {
		return GetVFunction<void(*)(UObject*, class UFunction*, void*)>(this, 59)(this, func, params);
		//return a_ProcessEvent(this, func, params);
	}
