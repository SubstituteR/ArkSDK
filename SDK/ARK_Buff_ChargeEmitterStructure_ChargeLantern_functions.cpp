...
#include "ARK_Buff_ChargeEmitterStructure_ChargeLantern_parameters.hpp"
...
// (NetReliable, Event, NetResponse, Static, Public, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
// (NetReliable, Exec, Native, Event, NetMulticast, Public, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// class AActor**                 emitterActor                   (Parm, ZeroConstructor, IsPlainOldData)
...
// (NetReliable, NetRequest, Native, Static, NetMulticast, Public, BlueprintCallable, BlueprintEvent, BlueprintPure)
