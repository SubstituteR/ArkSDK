...
#include "ARK_MoleRat_Character_BP_parameters.hpp"
...
// (NetReliable, Event, NetResponse, Protected, Delegate, NetServer, NetClient, BlueprintCallable, BlueprintEvent)
...
// (NetReliable, Native, NetResponse, NetMulticast, Protected, Delegate, NetServer, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
...
// (Native, Static, NetMulticast, Protected, Delegate, NetServer, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<struct FHitResult>      HitTargets                     (Parm, OutParm, ZeroConstructor, ReferenceParm)
// float                          DeltaTime                      (Parm, ZeroConstructor, IsPlainOldData)
...
// (Native, Event, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
...
// (NetReliable, NetRequest, Native, Event, NetResponse, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
